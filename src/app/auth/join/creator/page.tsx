...
export default function CreatorSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/auth/signin?registered=true&type=creator");
    } catch (err: unknown) {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-3xl">Join as Project Creator</CardTitle>
              <CardDescription>
                Create your account and start posting projects to find local talent
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      value={formData.bio}
                      onChange={handleChange}
                      placeholder="Tell us about your projects and what you're looking for..."
                      rows={4}
                    />
